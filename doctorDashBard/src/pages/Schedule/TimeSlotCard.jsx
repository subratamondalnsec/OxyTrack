...
const TimeSlotCard = ({ slot, }) => {
  const isBooked = slot.available === true;
  ...
  return (
    <div className={`border ${isBooked ? 'border-red-300' : 'border-green-300'} rounded-md p-3 text-center`}>
      ...
      <div
       className={`${isBooked ? 'bg-red-200 text-red-700' : 'bg-green-200 text-green-700'} text-xs font-semibold rounded-sm cursor-pointer py-1 mb-1 select-none`}>
